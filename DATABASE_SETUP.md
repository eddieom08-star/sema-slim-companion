...
**Current (WRONG):**
```
postgresql://neondb_owner:npg_Oj9CZVqke2BQ@ep-young-haze-afdbcxgi.c-2.us-west2.aws.neon.tech/neondb?sslmode=require
                                                                           ^^^^^^^^
```

**Corrected (RIGHT):**
```
postgresql://neondb_owner:npg_Oj9CZVqke2BQ@ep-young-haze-afdbcxgi.c-2.us-west-2.aws.neon.tech/neondb?sslmode=require
                                                                           ^^^^^^^^^
```
...
NODE_ENV=production
PORT=10000
DATABASE_URL=postgresql://neondb_owner:npg_Oj9CZVqke2BQ@ep-young-haze-afdbcxgi.c-2.us-west-2.aws.neon.tech/neondb?sslmode=require
