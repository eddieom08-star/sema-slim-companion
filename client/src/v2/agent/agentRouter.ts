...
export function classifyIntent(text: string): Intent {
  ...
  if (has(['still hungry','feel full','quite full','very full','not hungry','craving','satiety','satisfied','fullness','appetite level','log my appetite','doing with appetite'])) return 'food.appetite'
