...
export class PdfExportService {
  ...
  private renderHeader(
    ...
    doc.fontSize(20).font('Helvetica-Bold').text('GLP FRIEND HEALTH REPORT', { align: 'center' });
  ...
  private renderFooter(doc: PDFKit.PDFDocument): void {
    ...
    doc.text('This report was generated by GLP Friend, a patient-managed GLP-1 medication companion app.', { align: 'center' });
    doc.text('Data is self-reported and should be verified with clinical measurements.', { align: 'center' });
    doc.moveDown(0.3);
    doc.text('For questions: support@glpfriend.com', { align: 'center' });
  }
